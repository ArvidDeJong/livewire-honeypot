...
- In a plain form, put `<x-honeypot />` inside the form and call `app(\Darvis\LivewireHoneypot\Services\HoneypotService::class)->validate($request->all())` in the controller. The component detects Livewire itself.
